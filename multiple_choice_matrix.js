function multiple_choice_matrix({ question_code, randomize, array_filter, exclusive_answers, hide_answers, validation } = {}) {
...
multiple_choice_matrix({
    ...
    exclusive_answers: {
        /* Define exclusive column codes horizontally */
        horizontal: [3, 4],
        /* OR - CAN BEHAVE STRANGELY IF USING SIMULTANEOUSLY BUT STILL WORKS (NOT RECOMMENDED)*/
    ...
    validation: {
        /* Set a required amout of checked options per row */
        n_required: 2,
        /* OR */
        /* Set a minimum amount of checked options per row */
        min_limit: 2,
